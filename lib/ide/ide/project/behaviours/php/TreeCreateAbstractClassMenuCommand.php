...
use ide\formats\templates\PhpAbstractFileTemplate;
use ide\formats\templates\PhpClassFileTemplate;
use ide\formats\templates\PhpFinalFileTemplate;
use ide\formats\templates\PhpTraitFileTemplate;
...
class TreeCreateAbstractClassMenuCommand extends AbstractMenuCommand
{
    protected $tree;
    ...
    public function onExecute($e = null, AbstractEditor $editor = null)
    {
        ...
        $dialog = new InputMessageBoxForm('Создание Abstract класса', 'Введите название для Abstract класса', '* Только валидное имя для класса');
        ...
        if ($name) {
            ...
            $template = new PhpAbstractFileTemplate(fs::nameNoExt($f), null);
