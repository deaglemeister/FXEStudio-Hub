...
class TreeJsonFileCommand extends AbstractMenuCommand
{
    protected $tree;
    ...
    public function onExecute($e = null, AbstractEditor $editor = null)
    {
        ...
        $dialog = new InputMessageBoxForm('Создание Json файла', 'Введите название для Json файла', '* Только валидное имя для интерфейса');
