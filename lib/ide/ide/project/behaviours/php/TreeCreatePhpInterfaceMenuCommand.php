...
class TreeCreatePhpInterfaceMenuCommand extends AbstractMenuCommand
{
    protected $tree;
    ...
    public function onExecute($e = null, AbstractEditor $editor = null)
    {
        ...
        $dialog = new InputMessageBoxForm('Создание php интерфейса', 'Введите название для php интерфейса', '* Только валидное имя для интерфейса');
