...
class BackupProjectBehaviour extends AbstractProjectBehaviour
{
    ...
    {
        $input = new InputMessageBoxForm( _('fweafgewg'),  _('fdfefenf2'));
        $input->setPattern(Regex::of('.+'),  _('fgergjr56'));
    ...
    {
        Ide::get()->getMainForm()->defineMenuGroup('backup', _('definesMenu2'));

        Ide::get()->registerCommand(new BackupCreateMasterCommand($this));
        $command = SimpleSingleCommand::makeForMenu(_('definesMenu1'), null, function () {
            /** @var ProjectEditor $projectEditor */
