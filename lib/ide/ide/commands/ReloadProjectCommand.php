...
class ReloadProjectCommand extends AbstractCommand
{
    ...
    public function makeUiForHead()
    {
        ...
        $this->startButton->text = _('Reload');
    ...
    public function onStopExecute(UXEvent $e = null, callable $callback = null)
    {
        ...
        $mainForm->showPreloader('Идёт остановка проекта, подождите');
