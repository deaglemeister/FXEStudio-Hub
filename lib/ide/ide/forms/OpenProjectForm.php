...
class OpenProjectForm extends AbstractIdeForm
{
    ...
    public function init()
    {
        ...
        $cellFactory = function (UXListCell $cell, IdeLibraryProjectResource $resource) {
            ...
            $line = new UXHBox([ico('openpro32'), $title]);
            ...
            foreach ($projects as $project) {
                ...
                $iconUsersPath = fs::parent($project->getPath()).'\.dn\ide\project\behaviours\FXECustomIcon.png';
                    ...
                    if(!fs::exists($iconUsersPath)){         
                        $iconUsersPath = 'res://.data/img/icons/programEx32.png';
                    }
            
                uiLater(function () use ($project, $template,$iconUsersPath) {
                    ...
                    $one->setImage(Ide::get()->getImage($iconUsersPath,null,false,true)->image);
