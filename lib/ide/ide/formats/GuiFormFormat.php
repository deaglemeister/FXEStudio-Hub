...
use ide\formats\form\context\UndoObjectMenuCommand;
...
class GuiFormFormat extends AbstractFormFormat
{
    ...
    function __construct()
    {
        ...
        $UndoObjectMenuCommand = new UndoObjectMenuCommand();
        // Context Menu.
        $this->register(new SelectAllMenuCommand());
        $this->register($UndoObjectMenuCommand);
        $this->register(new CutMenuCommand($UndoObjectMenuCommand));
        $this->register(new CopyMenuCommand($UndoObjectMenuCommand));
        $this->register(new PasteMenuCommand());
        $this->register(new DeleteMenuCommand($UndoObjectMenuCommand,true));
