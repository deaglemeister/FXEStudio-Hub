...
class CopyMenuCommand extends AbstractMenuCommand
{
    ...
    public function onExecute($e = null, AbstractEditor $editor = null, $disableCount = false, $isReturn = false)
    {
        ...
        if ($nodes) {
            ...
            if ($isReturn) {
                return $processor->format($document);
            }else {
