...
class FloatSliderPropertyEditor extends ElementPropertyEditor
{
    ...
    public function makeUi()
    {
        ...
        $this->textField->width = 56;
        $this->textField->minWidth = 44;
        $this->textField->maxWidth = 72;
    ...
    public function setTooltip($tooltip)
    {
        ...
        if ($this->slider) {
            $this->slider->tooltip = null;
        }

        if ($this->textField) {
            $placeholder = $this->getFieldPlaceholder();
            if ($placeholder) {
                $this->textField->promptText = $placeholder;
            }
            $this->textField->tooltip = null;
        }
    }
