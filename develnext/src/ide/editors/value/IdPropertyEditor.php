...
class IdPropertyEditor extends TextPropertyEditor
{
    public function makeUi()
    {
        ...
        $this->textField->classes->add('fxe-property-id-field');
        $this->textField->style = '-fx-border-width: 0; -fx-border-radius: 0; -fx-font-style: italic; -fx-font-weight: bold;';
    ...
    public function applyValue($value, $updateUi = true)
    {
        ...
        if ($editor instanceof FormEditor) {
            $result = $editor->requestSafeRename($this->designProperties->target, $value);
