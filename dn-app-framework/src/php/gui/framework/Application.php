...
class Application
{
    ...
    public function launch(callable $handler = null, callable $after = null)
    {
        ...
        $onStart = function () use ($mainFormClass, $splashFormClass, $showMainForm, $handler, $after) {
            ...
            $deferredInit = function () use ($handler, $after, $finishLaunch, $mainFormClass) {
                if ($handler) {
                    $handler();
                }
                ...
                if ($after) {
                    waitAsync(32, function () use ($after, $finishLaunch) {
                        $after();
                        waitAsync(32, $finishLaunch);
                    });
                } else {
                    waitAsync(32, $finishLaunch);
                }
